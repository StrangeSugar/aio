 ...
 *
 * 资源已绑定态读真实绑定源（agent-fixed-asset 表），与运行时一致。
 */

import { useState, useMemo, useEffect } from 'react';
import { Button, Input, Modal } from 'tea-component';
import { useTranslation } from 'react-i18next';
import { CodeIcon, BooksIcon } from 'tea-icons-react';
...
export default function AgentEditDialog({
  ...
  }, [agent, assets.loading, realBindingsLoaded]);
